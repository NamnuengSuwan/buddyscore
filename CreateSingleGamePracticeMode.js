...
export function CreateSingleGamePracticeMode() {
  ...
  const handleCreateGame = () => {
    ...
    // Add code for creating the game here
    navigate('SingleGamePracticeMode');
  };
  ...
  const renderHeader = () => {
    return (
      <View style={[styles.header, styles.shadow]}>
        <Text style={styles.headerTitle}>{'หน้าสร้างเกมเดี่ยวโหมดฝึกซ้อม'}</Text>
      </View>
    );
  };
